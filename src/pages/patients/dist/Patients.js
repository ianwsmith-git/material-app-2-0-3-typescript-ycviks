...
function getPatients(search) {
    return new DiaRegApi_1.DiaRegWebApiClient().getPatients(search);
}
function getPatientsConfig() {
    return new DiaRegApi_1.DiaRegWebApiClient().getPatientGridConfiguration();
}
...
function Patients() {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, getPatientsConfig().then(function (response) {
                        ...
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, getPatients(search).then(function (response) {
                                var _a;
                                if (response.status === "success") {
                                    var newRows = (_a = response.data) === null || _a === void 0 ? void 0 : _a.map(function (patient) {
                                        var _a, _b, _c, _d, _e;
                                        return {
                                            id: patient.id,
                                            ...
                                            city: (_b = (_a = patient.location) === null || _a === void 0 ? void 0 : _a.city) === null || _b === void 0 ? void 0 : _b.name,
                                            region: (_d = (_c = patient.location) === null || _c === void 0 ? void 0 : _c.region) === null || _d === void 0 ? void 0 : _d.name,
                                            ...
                                            gender: (_e = patient.gender) === null || _e === void 0 ? void 0 : _e.name
                                        };
                                    });
                                    if (!active) {
                                        return;
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement(core_1.Collapse, { "in": openAlert },
            react_1["default"].createElement(Alert_1["default"], { variant: "filled", severity: alertSeverity, action: react_1["default"].createElement(core_1.IconButton, { "aria-label": "close", color: "inherit", size: "small", onClick: function (e) {
                        setOpenAlert(false);
                        e.preventDefault();
                    } },
