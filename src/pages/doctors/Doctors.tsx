...
export default function Doctors() {
    ...
    return (
        ...
        <React.Fragment>
            ...
            <ListPage title="Doctors" data={rows} columns={columns} allowDelete={false} allowEdit={true} rowCount={rowCount} allowPaging={true} pagingHandler={handlePageChange} filterHander={handleFilter} viewItemHandler={handleView} />
