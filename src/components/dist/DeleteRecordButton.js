...
var DeleteRecordButton = /** @class */ (function (_super) {
    __extends(DeleteRecordButton, _super);
    function DeleteRecordButton() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = { open: false };
        _this.handleOKClose = function () {
            _this.setState({ open: false });
            _this.props.deleteRecordHandler(_this.props.index);
        };
    ...
    DeleteRecordButton.prototype.render = function () {
        var classes = this.props.classes;
        return (react_1["default"].createElement("div", null,
            this.props.hidden === false ?
                react_1["default"].createElement(Button_1["default"], { variant: "contained", color: "primary", onClick: this.handleClick }, this.props.buttonText)
                :
                    null,
            this.state.open === true ?
                react_1["default"].createElement(Dialog_1["default"], { open: this.state.open, "aria-labelledby": "form-dialog-title", maxWidth: "lg", disableBackdropClick: true, disableEscapeKeyDown: true },
                    ...
                    react_1["default"].createElement(DialogContent_1["default"], { dividers: true, className: classes.root },
                        react_1["default"].createElement(DialogContentText_1["default"], null, "You are about to delete data that cannot be restored.  Click Cancel to cancel the delete otherwise click OK to delete the record.")),
 ...
 */
exports["default"] = core_1.withStyles(dialogStyle)(DeleteRecordButton);
